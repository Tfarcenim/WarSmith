...
public class ModItems {
    ...
    public static final Item IRON_KUSARIGAMA = new KusarigamaItem(Tiers.IRON,3,-2.5,new Item.Properties());
    public static final Item DIAMOND_KUSARIGAMA = new KusarigamaItem(Tiers.DIAMOND,3,-2.5,new Item.Properties());
    public static final Item NETHERITE_KUSARIGAMA = new KusarigamaItem(Tiers.NETHERITE,3,-2.5,new Item.Properties());
