...
public class ModEnchantments {
    ...
    public static final Enchantment SLEIGHT_OF_HAND = new SleightOfHandEnchantment(Enchantment.Rarity.RARE, ModEnchantmentCategories.SLEIGHT_OF_HAND, EquipmentSlot.MAINHAND);
    ...
    public static final Enchantment PIERCING_DASH = new PiercingDashEnchantment(Enchantment.Rarity.RARE,ModEnchantmentCategories.RAPIER,EquipmentSlot.MAINHAND);
