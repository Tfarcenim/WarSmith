package tfar.warsmith.client.render;
...
public class KusarigamaEntityRenderer extends EntityRenderer<KusarigamaEntity> {
    ...
    public KusarigamaEntityRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    public void render(KusarigamaEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
        ...
        if (player != null) {
            ...
            if (!(itemstack.getItem() instanceof KusarigamaItem)) {
                i = -i;
            }
     ...
     */
    @Override
    public ResourceLocation getTextureLocation(KusarigamaEntity pEntity) {
