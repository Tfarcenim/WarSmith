...
public class ClientMisc {
    ...
    public static void tooltip(ItemStack stack, TooltipFlag context, List<Component> lines) {
        CompoundTag tag = stack.getTag();
        if (tag != null && tag.contains("sharpened")) {
            lines.add(Component.translatable(WarSmith.SHARPENED_TOOLTIP_KEY,tag.getInt("sharpened")));
        }
    }
